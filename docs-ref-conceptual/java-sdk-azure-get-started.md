...
---
# <a name="get-started-with-the-azure-libraries-for-java"></a>Начало работы с библиотеками Azure для Java

В этом руководстве описано, как настроить среду разработки с использованием субъекта-службы Azure. Рассматривается пример кода, который создает и использует ресурсы в подписке Azure с помощью библиотек Azure для Java.
...
- [Java 8](http://www.oracle.com/technetwork/java/javase/downloads/index.html) (в составе Azure Cloud Shell)
...
[Создайте субъект-службу с помощью Azure CLI 2.0](/cli/azure/create-an-azure-service-principal-azure-cli) и запишите выходные данные. Вместо `MY_SECURE_PASSWORD` нужно указать в аргументе пароля [безопасный пароль](https://docs.microsoft.com/azure/active-directory/active-directory-passwords-policy).
...
Сохраните этот файл в безопасном расположении в вашей системе, доступном для кода. Задайте переменную среды `AZURE_AUTH_LOCATION` и укажите полный путь к файлу аутентификации в оболочке.    
