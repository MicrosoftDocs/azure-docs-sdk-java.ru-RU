...
ms.locfileid: "52338858"
---
# <a name="whats-new-in-the-azure-toolkit-for-eclipse"></a><span data-ttu-id="d78e0-103">Новые возможности набора средств Azure для Eclipse</span><span class="sxs-lookup"><span data-stu-id="d78e0-103">What's new in the Azure Toolkit for Eclipse</span></span>

<span data-ttu-id="d78e0-104">На этой странице представлены сведения о разных выпусках и последних обновлениях набора средств Azure для Eclipse.</span><span class="sxs-lookup"><span data-stu-id="d78e0-104">The following web page contains information on the various releases and latest updates to the Azure Toolkit for Eclipse.</span></span>

<https://github.com/Microsoft/azure-tools-for-java/releases>

> [!NOTE] 
> <span data-ttu-id="d78e0-105">Также имеется набор средств Azure для интегрированной среды разработки IntelliJ.</span><span class="sxs-lookup"><span data-stu-id="d78e0-105">There is also an Azure Toolkit for the IntelliJ IDE.</span></span> <span data-ttu-id="d78e0-106">Дополнительные сведения см. в разделе [Набор средств Azure для IntelliJ].</span><span class="sxs-lookup"><span data-stu-id="d78e0-106">For more information, see [Azure Toolkit for IntelliJ].</span></span> 
> 
...
## <a name="next-steps"></a><span data-ttu-id="d78e0-107">Дополнительная информация</span><span class="sxs-lookup"><span data-stu-id="d78e0-107">Next steps</span></span>
