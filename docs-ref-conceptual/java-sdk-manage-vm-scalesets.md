...
## <a name="create-a-scale-set"></a><span data-ttu-id="8145b-117">Создание масштабируемого набора</span><span class="sxs-lookup"><span data-stu-id="8145b-117">Create a scale set</span></span>
