...
ms.locfileid: "52338828"
---
# <a name="whats-new-in-the-azure-toolkit-for-intellij"></a><span data-ttu-id="d666e-103">Новые возможности набора средств Azure для IntelliJ</span><span class="sxs-lookup"><span data-stu-id="d666e-103">What's New in the Azure Toolkit for IntelliJ</span></span>

<span data-ttu-id="d666e-104">На этой странице представлены сведения о разных выпусках и последних обновлениях набора средств Azure для IntelliJ.</span><span class="sxs-lookup"><span data-stu-id="d666e-104">The following web page contains information on the various releases and latest updates to the Azure Toolkit for IntelliJ.</span></span>

<https://github.com/Microsoft/azure-tools-for-java/releases>

> [!NOTE] 
> <span data-ttu-id="d666e-105">Также имеется набор средств Azure для интегрированной среды разработки Eclipse.</span><span class="sxs-lookup"><span data-stu-id="d666e-105">There is also an Azure Toolkit for the Eclipse IDE.</span></span> <span data-ttu-id="d666e-106">Дополнительные сведения см. в разделе [Набор средств Azure для Eclipse].</span><span class="sxs-lookup"><span data-stu-id="d666e-106">For more information, see [Azure Toolkit for Eclipse].</span></span> 
> 
...
## <a name="next-steps"></a><span data-ttu-id="d666e-107">Дополнительная информация</span><span class="sxs-lookup"><span data-stu-id="d666e-107">Next steps</span></span>
